...
public:
  ...
  void write_reg_to_buf(uint8_t add, uint8_t reg, uint8_t *buf, uint8_t size);
  ...
  void write_reg16(uint8_t add, uint8_t reg, uint16_t val);
  void write_reg32(uint8_t add, uint8_t reg, uint32_t val);

	uint8_t  read_reg(uint8_t add, uint8_t reg);
  uint16_t read_reg16(uint8_t add, uint8_t reg);
  uint32_t read_reg32(uint8_t add, uint8_t reg);
